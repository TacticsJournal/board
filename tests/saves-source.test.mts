...
test('user-facing plan copy names Free and Pro exactly', () => {
  ...
  assert.match(main, /data-pro-amount>\$12\.42<\/span><span class=\"proCardPer\">\/month/)
  assert.match(main, /yearly \? '\$12\.42' : '\$14\.99'/)
  assert.match(main, /yearly \? 'Billed yearly at \$149' : 'Billed monthly at \$14\.99'/)
  assert.match(main, /Save \$30\.88 versus monthly/)
